...
export default async function updateAccount(context, input) {
  ...
  if (typeof termAndConditions === "boolean" || termAndConditions === null){
    updates["profile.termAndConditions"] = termAndConditions;
    updatedFields.push("termAndConditions");
  }

  if (typeof isAdult === "boolean" || isAdult === null){
    updates["profile.isAdult"] = isAdult;
    updatedFields.push("isAdult");
  }

  if (typeof personalDataToOtherCompanies === "boolean" || personalDataToOtherCompanies === null){
    updates["profile.personalDataToOtherCompanies"] = personalDataToOtherCompanies;
    updatedFields.push("personalDataToOtherCompanies");
  }

  if (typeof personalDataToPromotionalOffers === "boolean" || personalDataToPromotionalOffers === null){
    updates["profile.personalDataToPromotionalOffers"] = personalDataToPromotionalOffers;
